...
exports.SellerLeadControllerTest = void 0;
...
var getSellerLeadById = function (id, name) { return __awaiter(void 0, void 0, void 0, function () {
    var response2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client_test_1.client.sellerLeadTemplate.getOne('/sellerLead', id)];
            case 1:
                response2 = _a.sent();
                chai_1.assert.equal(response2.status.code, 200);
                chai_1.assert.equal(response2.result.name, name);
...
function SellerLeadControllerTest() {
    describe("Controller Test", function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                describe("Seller Lead Controller Test", function () {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            it("Seller Lead Create", function () {
                                return __awaiter(this, void 0, void 0, function () {
                                    var response, id;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                id = response.result;
                                                return [4 /*yield*/, getSellerLeadById(id, "Test")];
                                            case 2:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
                            ...
                            it("Seller Lead  Get Request", function () {
                                return __awaiter(this, void 0, void 0, function () {
                                    var response;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, client_test_1.client.sellerLeadTemplate.getAll('/sellerLead')];
                                            case 1:
                                                response = _a.sent();
                            ...
                            it("Seller Lead Update Request", function () {
                                return __awaiter(this, void 0, void 0, function () {
                                    var result, id, seller, response;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, createSellerLead()];
                                            case 1:
                                                ...
                                                return [4 /*yield*/, client_test_1.client.sellerLeadTemplate.update(seller, '/sellerLead', id)];
                                            case 2:
                                                response = _a.sent();
                                                chai_1.assert.equal(response.status.code, 200);
                                                chai_1.assert.exists(response.result);
                                                return [4 /*yield*/, getSellerLeadById(id, seller.name)];
                                            case 3:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
                            ...
                            it("Seller Lead Delete Request", function () {
                                return __awaiter(this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                result = _a.sent();
                                                id = result.result;
                                                return [4 /*yield*/, client_test_1.client.sellerLeadTemplate.delete('/sellerLead', id)];
                                            case 2:
                                                response = _a.sent();
                                                chai_1.assert.equal(response.status.code, 200);
                                                ...
                                                chai_1.assert.exists(response.result);
                                                chai_1.assert.isFalse(response.status.error);
                                                return [4 /*yield*/, client_test_1.client.sellerLeadTemplate.getOne('/sellerLead', id)];
                                            case 3:
                                                response2 = _a.sent();
                            ...
                            it("Seller Lead to Seller conversion Request", function () {
                                return __awaiter(this, void 0, void 0, function () {
...
exports.SellerLeadControllerTest = SellerLeadControllerTest;
